/*
  ...
  Modify state.component.ts instead.
*/
...
export class StateGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0Add(event: any) {
    this.dialogService.open(AddStateComponent, { parameters: {}, title: 'Add State' });
  }

  grid0RowSelect(event: any) {
    this.dialogService.open(EditStateComponent, { parameters: {Id: event.Id}, title: 'Edit State' });
  }
}
