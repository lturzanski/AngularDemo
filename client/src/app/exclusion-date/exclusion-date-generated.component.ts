/*
  ...
  Modify exclusion-date.component.ts instead.
*/
...
export class ExclusionDateGenerated implements AfterViewInit, OnInit, OnDestroy {
  ...
  grid0Add(event: any) {
    this.dialogService.open(AddExclusionDateComponent, { parameters: {}, title: 'Add Exclusion Date' });
  }
  ...
  grid0RowSelect(event: any) {
    this.dialogService.open(EditExclusionDateComponent, { parameters: {Id: event.Id}, title: 'Edit Exclusion Date' });
  }
}
