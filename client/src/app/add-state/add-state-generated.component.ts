/*
  ...
  Modify add-state.component.ts instead.
*/
...
export class AddStateGenerated implements AfterViewInit, OnInit, OnDestroy {
  // Components
  ...
  form0Submit(event: any) {
    this.stateExclusions.createStateExclState(null, event)
    .subscribe((result: any) => {
      ...
      this.notificationService.notify({ severity: "error", summary: `Error`, detail: `Unable to create new StateExclState!` });
    });
  }
}
